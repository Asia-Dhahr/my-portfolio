...
const WebDeveloper = () => {
    ...
    return (
        <div>
            <div className=" lg:bg-cover bg-no-repeat md:bg-cover sm:bg-cover bg-center h-screen lg:bg-[url('/web/web.png')] sm:bg-[url('/web/web.png')] md:bg-[url('/web/webm.png')] bg-[url('/web/webs.png')] bg-cover">
                <div className="sm:pt-3 pt-2 lg:pl-8 pl-2">
                ...
                <div className="pt-10 sm:pt-0 font-bold lg:text-xl md:text-lg sm:text-md text-md  text-green-400 lg:h-44 md:h-44 sm:h-6 h-24 w-40 my-3">
                    <h1 className="pb-1 lg:my-24  lg:ml-3 ml-2 lg:-rotate-90 md:-rotate-90 border-b-4 w-20 border-sky-600">Web_Developer</h1>
                </div>
                <div className="lg:flex md:flex sm:flex grid justify-center items-center p-3  lg:mt-10 md:mt-10 sm:mt-5 mt-0 lg:gap-28 md:gap-16 sm:gap-10 gap-10 text-blue-50">
            ...
            {/* ==========================================p2  */}
            <div className="bg-[url('/web/p2.png')] h-screen bg-cover bg-scroll">
                ...
                <div className="flex justify-center place-items-center text-white mx-4 sm:pt-10 pt-20">
                    <div className="lg:flex md:flex sm:flex grid justify-center place-items-center lg:gap-36 md:gap-10 sm:gap-5 gap-5 mt-0 sm:mx-3">
                        <section className="text-blue-50 lg:w-1/4 md:w-2/5 sm:w-80 w-3/4  ">
                            <div className="ux lg:mb-20 md:mb-20 sm:mb-10 mb-7">
                ...
                <div className="flex justify-center">
                    <section className="lg:w-2/3 md:w-full sm:w-full w-full lg:mt-10 md:mt-10 sm:mt-10 mt-20 lg:mb-14 md:mb-14 sm:mb-7 mb-7">
                        <h1 className="lg:mx-12 md:mx-10 sm:mx-4 mx-10 text-blue-50 border-b-3 lg:text-xl md:text-xl sm:text-xl text-lg font-semibold "><span className="span">Design</span> Skills</h1>
                    </section>
                </div>
                    ...
                    <div className="flex flex-rows lg:gap-20 md:gap-4 sm:gap-0 gap-0 w-4/6 place-content-center ">
                        <section className="flex flex-col lg:gap-6 md:gap-6 sm:gap-6 gap-4">
                            <div className=" display-block text-blue-50">
                                ...
                                <div className="bg-[url('/web/opacity.png')] bg-no-repeat bg-cover lg:w-96 md:w-72 sm:w-64 w-[37] lg:h-4 md:h-4 sm:h-4 h-3  rounded-r-xl rounded-l-2xl ">
                                    <div className="rate lg:w-11/12 md:w-64 sm:w-60 w-36 lg:h-4 md:h-4 sm:h-4 h-3 bg-green-400 rounded-r-full rounded-l-full shadow-lg hover:shadow-green-400/50 hover:text-green-300 transition duration-300"></div>
                                </div>
                            </div>
                            <div className=" display-block text-blue-50">
                                <h1 className="mb-3 font-base lg:text-lg md:text-base sm:text-base text-sm">Adobe XD</h1>
                                <div className="bg-[url('/web/opacity.png')] bg-no-repeat bg-cover lg:w-96 md:w-72 sm:w-64 w-[37] lg:h-4 md:h-4 sm:h-4 h-3  rounded-r-xl rounded-l-2xl ">
                                    <div className="rate lg:w-72 md:w-60 sm:w-52 w-32 lg:h-4 md:h-4 sm:h-4 h-3 bg-green-400 rounded-r-full rounded-l-full shadow-lg hover:shadow-green-400/50 hover:text-green-300 transition duration-300"></div>
                                </div>
                            </div>
                            <div className=" display-block text-blue-50">
                                <h1 className="mb-3 font-base lg:text-lg md:text-base sm:text-base text-sm">Krita</h1>
                                <div className="bg-[url('/web/opacity.png')] bg-no-repeat bg-cover lg:w-96 md:w-72 sm:w-64 w-[37] lg:h-4 md:h-4 sm:h-4 h-3 rounded-r-xl rounded-l-2xl ">
                                    <div className="rate lg:w-80 md:w-64 sm:w-56 w-36 lg:h-4 md:h-4 sm:h-4 h-3 bg-green-400 rounded-r-full rounded-l-full shadow-lg hover:shadow-green-400/50 hover:text-green-300 transition duration-300"></div>
                                </div>
                            </div>
                        </section>
                        <section className="flex flex-col lg:gap-6 md:gap-6 sm:gap-6 gap-4">
                            ...
                            <div className=" display-block text-blue-50 lg:ml-0 md:ml-10 sm:ml-10 ml-10">
                                ...
                                <div className="bg-[url('/web/opacity.png')] bg-no-repeat bg-cover lg:w-96 md:w-72 sm:w-64 w-[37] lg:h-4 md:h-4 sm:h-4 h-3  rounded-r-xl rounded-l-2xl ">
                                    <div className="rate lg:w-80 md:w-64 sm:w-60 w-36 lg:h-4 md:h-4 sm:h-4 h-3 bg-green-400 rounded-r-full rounded-l-full shadow-lg hover:shadow-green-400/50 hover:text-green-300 transition duration-300"></div>
                                </div>
                            </div>
                            <div className=" display-block text-blue-50 lg:ml-0 md:ml-10 sm:ml-10 ml-10">
            ...
            {/* ====================================================p3  */}
            <div className="h-screen bg-cover  bg-scroll bg-no-repeat bg-center lg:bg-[url('/web/p3.png')] sm:bg-[url('/web/p3-3.png')] md:bg-[url('/web/p3-2.png')] bg-[url('/web/p3.png')] ">
                <div className="flex justify-center">
                    <section className="lg:w-2/3 md:w-full sm:w-full w-full lg:mt-10 md:mt-10 mt-80 lg:mb-14 md:mb-14 sm:mb-7 mb-7">
                        <h1 className="wd lg:mx-12 md:mx-10 sm:mx-4 mx-10 text-blue-50 border-b-3 font-semibold lg:text-2xl md:text-2xl sm:text-2xl text-xl">Web Developer</h1>
                        <h2 className="lg:mx-12 md:mx-10 sm:mx-4 mx-10 text-blue-50 border-b-3 lg:text-xl md:text-xl sm:text-xl text-lg  font-semibold lg:mt-16 md:mt-16 sm:mt-10 mt-10"><span className="span">Program</span> Skills</h2>
                    </section>
                </div>
                    ...
                    <div className="flex flex-rows lg:gap-20 md:gap-4 sm:gap-0 gap-0 w-4/6 place-content-center ">
                        ...
                        <section className="flex flex-col lg:gap-6 md:gap-6 sm:gap-6 gap-4">
                            <div className=" display-block text-blue-50 lg:ml-0 md:ml-10 sm:ml-10 ml-10">
                                ...
                                <div className="bg-[url('/web/opacity.png')] bg-no-repeat bg-cover lg:w-96 md:w-72 sm:w-64 w-[37] lg:h-4 md:h-4 sm:h-4 h-3  rounded-r-xl rounded-l-2xl ">
                                    <div className="rate lg:w-72 md:w-60 sm:w-52 w-36 lg:h-4 md:h-4 sm:h-4 h-3 bg-green-400 rounded-r-full rounded-l-full shadow-lg hover:shadow-green-400/50 hover:text-green-300 transition duration-300"></div>
                                </div>
                            </div>
                            <div className=" display-block text-blue-50 lg:ml-0 md:ml-10 sm:ml-10 ml-10">
                                <h1 className="mb-3 font-base lg:text-lg md:text-base sm:text-base text-sm">Nodejs / Express</h1>
                                <div className="bg-[url('/web/opacity.png')] bg-no-repeat bg-cover lg:w-96 md:w-72 sm:w-64 w-[37] lg:h-4 md:h-4 sm:h-4 h-3 rounded-r-xl rounded-l-2xl ">
                                    <div className="rate lg:w-68 md:w-56 sm:w-48 w-28 lg:h-4 md:h-4 sm:h-4 h-3 bg-green-400 rounded-r-full rounded-l-full shadow-lg hover:shadow-green-400/50 hover:text-green-300 transition duration-300"></div>
                                </div>
                            </div>
                            <div className=" display-block text-blue-50 lg:ml-0 md:ml-10 sm:ml-10 ml-10">
                                <h1 className="mb-3 font-base lg:text-lg md:text-base sm:text-base text-sm">MySQL / Mongodb</h1>
                                <div className="bg-[url('/web/opacity.png')] bg-no-repeat bg-cover lg:w-96 md:w-72 sm:w-64 w-[37] lg:h-4 md:h-4 sm:h-4 h-3  rounded-r-xl rounded-l-2xl ">
                                    <div className="rate lg:w-56 md:w-54 sm:w-48 w-28 lg:h-4 md:h-4 sm:h-4 h-3 bg-green-400 rounded-r-full rounded-l-full shadow-lg hover:shadow-green-400/50 hover:text-green-300 transition duration-300"></div>
                                </div>
                            </div>
                            <div className=" display-block text-blue-50 lg:ml-0 md:ml-10 sm:ml-10 ml-10">
                ...
                <div className="flex justify-center items-center text-center lg:mt-28 md:mt-28  sm:mt-14 mt-28  md:mr-12 gap-6 text-blue-50 ">
