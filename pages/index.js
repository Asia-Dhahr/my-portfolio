...
export default function Home() {
  ...
  return (
    <div className=" lg:bg-cover bg-no-repeat md:bg-cover sm:bg-cover bg-center h-screen overflow-auto bg-fix lg:bg-[url('/bg.png')] sm:bg-[url('/bg2.png')] md:bg-[url('/bg.png')] bg-[url('/bg2.png')] bg-cover">
      <div className="flex justify-start lg:mx-20 sm:ml-6 h-fit  w-fit">
        <img className="h-10 sm:h-9 lg:h-20 sm:mt-1 mt-4 md:mt-2 md:ml-2 ml-4 object-contain" src="logo.png" />
      </div>
      ...
      <div className="flex justify-center items-baseline sm:gap-28 md:gap-28 xl:gap-40 gap-8 lg:mx-18 md:mx-18 mt-24 lg:mt-10 md:mt-10 sm:mt-8 px-5 ">
